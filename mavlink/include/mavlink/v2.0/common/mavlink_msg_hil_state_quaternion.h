...
typedef struct __mavlink_hil_state_quaternion_t {
 ...
 float vario; /* Body frame variometer*/
...
#define MAVLINK_MESSAGE_INFO_HIL_STATE_QUATERNION { \
    ...
    {  { "time_usec", NULL, MAVLINK_TYPE_UINT64_T, 0, 0, offsetof(mavlink_hil_state_quaternion_t, time_usec) }, \
         ...
         { "vario", NULL, MAVLINK_TYPE_FLOAT, 0, 36, offsetof(mavlink_hil_state_quaternion_t, vario) }, \
         { "lat", NULL, MAVLINK_TYPE_INT32_T, 0, 40, offsetof(mavlink_hil_state_quaternion_t, lat) }, \
         { "lon", NULL, MAVLINK_TYPE_INT32_T, 0, 44, offsetof(mavlink_hil_state_quaternion_t, lon) }, \
         { "alt", NULL, MAVLINK_TYPE_INT32_T, 0, 48, offsetof(mavlink_hil_state_quaternion_t, alt) }, \
         { "vx", NULL, MAVLINK_TYPE_INT16_T, 0, 52, offsetof(mavlink_hil_state_quaternion_t, vx) }, \
         { "vy", NULL, MAVLINK_TYPE_INT16_T, 0, 54, offsetof(mavlink_hil_state_quaternion_t, vy) }, \
         { "vz", NULL, MAVLINK_TYPE_INT16_T, 0, 56, offsetof(mavlink_hil_state_quaternion_t, vz) }, \
         { "ind_airspeed", NULL, MAVLINK_TYPE_UINT16_T, 0, 58, offsetof(mavlink_hil_state_quaternion_t, ind_airspeed) }, \
         { "true_airspeed", NULL, MAVLINK_TYPE_UINT16_T, 0, 60, offsetof(mavlink_hil_state_quaternion_t, true_airspeed) }, \
         { "xacc", NULL, MAVLINK_TYPE_INT16_T, 0, 62, offsetof(mavlink_hil_state_quaternion_t, xacc) }, \
         { "yacc", NULL, MAVLINK_TYPE_INT16_T, 0, 64, offsetof(mavlink_hil_state_quaternion_t, yacc) }, \
         { "zacc", NULL, MAVLINK_TYPE_INT16_T, 0, 66, offsetof(mavlink_hil_state_quaternion_t, zacc) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_HIL_STATE_QUATERNION { \
 ...
 * @param vario Body frame variometer
...
static inline uint16_t mavlink_msg_hil_state_quaternion_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint64_t time_usec, const float *attitude_quaternion, float rollspeed, float pitchspeed, float yawspeed, float vario, int32_t lat, int32_t lon, int32_t alt, int16_t vx, int16_t vy, int16_t vz, uint16_t ind_airspeed, uint16_t true_airspeed, int16_t xacc, int16_t yacc, int16_t zacc)
{
    ...
    _mav_put_float(buf, 36, vario);
    _mav_put_int32_t(buf, 40, lat);
    _mav_put_int32_t(buf, 44, lon);
    _mav_put_int32_t(buf, 48, alt);
    _mav_put_int16_t(buf, 52, vx);
    _mav_put_int16_t(buf, 54, vy);
    _mav_put_int16_t(buf, 56, vz);
    _mav_put_uint16_t(buf, 58, ind_airspeed);
    _mav_put_uint16_t(buf, 60, true_airspeed);
    _mav_put_int16_t(buf, 62, xacc);
    _mav_put_int16_t(buf, 64, yacc);
    _mav_put_int16_t(buf, 66, zacc);
 ...
 * @param pitchspeed Body frame pitch / theta angular speed (rad/s)
 * @param yawspeed Body frame yaw / psi angular speed (rad/s)
 * @param vario Body frame variometer (m/s)
 * @param lat Latitude, expressed as * 1E7
 * @param lon Longitude, expressed as * 1E7
 * @param alt Altitude in meters, expressed as * 1000 (millimeters)
 * @param vx Ground X Speed (Latitude), expressed as m/s * 100
...
/**
 * @brief Get field vario from hil_state_quaternion message
 *
 * @return Body frame variometer (m/s)
 */
static inline float mavlink_msg_hil_state_quaternion_get_vario(const mavlink_message_t* msg)
{
...
static inline void mavlink_msg_hil_state_quaternion_decode(const mavlink_message_t* msg, mavlink_hil_state_quaternion_t* hil_state_quaternion)
{
    ...
    hil_state_quaternion->vario = mavlink_msg_hil_state_quaternion_get_vario(msg);
